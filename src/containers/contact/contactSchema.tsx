...
const ContactSchema = () => {
    return (
        <>
                    ...
                    <div className="flex flex-wrap -mx-4 lg:justify-between">
                        ...
                        <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
                            <div className="relative p-8 bg-white rounded-lg shadow-lg dark:bg-dark-2 sm:p-12">
                                <ContactForm />
                                <div>
                                    <span className="absolute -top-10 md:-right-9 -right-5 z-[-1]">
                                        <svg
                                            width="100"
                                            height="100"
                                            viewBox="0 0 100 100"
                                    ...
                                    <span className="absolute md:-right-10 -right-5 top-[90px] z-[-1]">
                                        <svg
                                            width="34"
                                            height="134"
                                            viewBox="0 0 34 134"
                                    ...
                                    <span className="absolute md:-left-7 -left-5 -bottom-7 z-[-1]">
                                        <svg
                                            width="107"
                                            height="134"
                                            viewBox="0 0 107 134"
            ...
            <section className="md:mt-5 mt-14">
